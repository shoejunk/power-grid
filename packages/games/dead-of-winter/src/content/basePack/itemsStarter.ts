...
export const BASE_STARTER_ITEMS: ItemCardDefinition[] = [
  ...
  {
    id: 'it-work-detail',
    name: 'Volunteer Work Detail',
    text: 'Place two barricades in empty entrance spaces at your location and raise morale by one.',
    ...
    onPlay: {
      kind: 'sequence',
      effects: [
        { kind: 'addBarricade', count: 2, location: { kind: 'sourceLocation' } },
        { kind: 'adjustMorale', amount: 1 },
      ],
    },
    nonCooperative: false,
  ...
  {
    id: 'it-scared-kid',
    name: 'Kid Hiding in the Vents',
    text: 'If the colony has an empty survivor space, add one helpless survivor there and raise morale by one. Otherwise lower morale by one.',
    symbols: ['survivor'],
    deck: 'starter',
    textKind: 'outsider',
    kind: 'oneShot',
    // The colony either finds room or turns a child away, and the morale track
    // records which. §9.4 makes the helpless survivor a standing liability.
    onPlay: {
      kind: 'branch',
      test: { kind: 'colonyHasEmptySurvivorSpace' },
      then: {
        kind: 'sequence',
        effects: [
