...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  override render(): ReactNode {
    ...
    return (
      <div className="pg-screen pg-crash">
        <Panel title="Something broke" ticks className="pg-crash__panel" padding="roomy">
          <div className="pg-crash__icon">
            <IconWarning />
          </div>
          <p className="pg-body">
          ...
          <pre className="pg-crash__detail">{error.message}</pre>
          <div className="pg-crash__actions">
