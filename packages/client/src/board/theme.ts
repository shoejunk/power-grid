...
export function boardTheme(): BoardTheme {
  ...
  cache = {
    void: hex(cssColor('--pg-surface-void', 0x04070a)),
    base: hex(cssColor('--pg-surface-base', 0x070b10)),
    sunken: hex(cssColor('--pg-surface-sunken', 0x0a1018)),
    panel: hex(cssColor('--pg-surface-panel', 0x141d28)),
    elevated: hex(cssColor('--pg-surface-elevated', 0x1b2634)),
    line: hex(cssColor('--pg-line', 0x9ac0e1)),
    lineStrong: hex(cssColor('--pg-line-strong', 0xa8d0f0)),
    text: hex(cssColor('--pg-text-primary', 0xdfe8f2)),
    textMuted: hex(cssColor('--pg-text-muted', 0x8497ab)),
    textFaint: hex(cssColor('--pg-text-faint', 0x74879c)),
    cyan: hex(cssColor('--pg-cyan', 0x46e2ff)),
    cyanBright: hex(cssColor('--pg-cyan-bright', 0x8df3ff)),
    copper: hex(cssColor('--pg-copper', 0xd9813f)),
    copperBright: hex(cssColor('--pg-copper-bright', 0xf7a85f)),
    elektro: hex(cssColor('--pg-elektro', 0xffd166)),
    elektroDim: hex(cssColor('--pg-elektro-dim', 0xa37820)),
    success: hex(cssColor('--pg-success', 0x3ad693)),
    danger: hex(cssColor('--pg-danger', 0xff5563)),
