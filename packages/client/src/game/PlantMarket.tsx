  ...
  return (
    ...
    >
      <div className="pg-gmarketrow">
        <span className="pg-gmarketrow__tag pg-overline">
          Current
          <em>biddable</em>
        </span>
      ...
      <div className="pg-gmarketrow pg-gmarketrow--future">
        ...
        <div className="pg-gplantrow">
          {step3 ? (
            <span className="pg-gnote pg-caption">
              Step 3 removed the future market — every plant on the board is up for auction.
            </span>
          ) : market.future.length === 0 ? (
            <span className="pg-gnote pg-caption">The stack is exhausted; no future plants remain.</span>
          ) : (
            <AnimatePresence initial={false} mode="popLayout">
