  ...
  return (
    <div className="pg-gboard">
      ...
      <div className="pg-gboard__inner">
        <span className="pg-overline">{map.name}</span>
        ...
        <div className="pg-gboard__areas">
          {zoneAreas.map((area) => (
            <span key={area.id} className="pg-gboard__area" style={{ ['--pg-area' as string]: area.color }}>
              <i />
              {area.name}
              <b className="pg-numeral">{map.cities.filter((c) => c.area === area.id).length}</b>
            </span>
          ))}
        </div>
          ...
          {state.playerOrder
            ...
            .map((player) => (
              <span key={player!.id} className="pg-gboard__net" data-player-color={player!.color}>
                <i />
                {player!.name}
                <b className="pg-numeral">{player!.cities.length}</b>
              </span>
            ))}
        </div>
      </div>
