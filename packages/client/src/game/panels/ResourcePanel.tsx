  ...
  return (
    ...
    >
      ...
      <div className="pg-gsummary">
        <Stat label="Tokens" value={<span className="pg-numeral">{tokens}</span>} />
...
function ResourceRow({
  ...
  return (
    <div className="pg-gbuy__row" data-res={option.resource} data-blocked={blocked}>
      ...
      <span className="pg-gbuy__avail pg-caption">
        <span className="pg-numeral">{option.available}</span> available
      </span>
      ...
      {option.fromUsaCoalStorage ? (
        <span className="pg-gbuy__note pg-caption">
...
function MyStorage({ draft }: { draft: ResourceBundle | null }): JSX.Element | null {
  ...
  return (
    <div className="pg-gstorage">
      <span className="pg-overline pg-gsectionlabel">Your storage</span>
      {me.plants
        .slice()
        ...
        .map((owned) => {
          ...
          return (
            <motion.div key={owned.plantId} className="pg-gstorage__row" layout transition={springSoft}>
              <span className="pg-gstorage__id pg-numeral">{owned.plantId}</span>
              <span className="pg-gstorage__meta">
                ...
                <span className="pg-gstorage__cap pg-caption">
                  <span className="pg-numeral">{held}</span> / {plantStorage(owned.plantId)}
                </span>
              </span>
