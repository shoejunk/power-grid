  ...
  return (
    ...
    >
        ...
        {sequence.map((player) => {
          ...
          return (
            ...
            >
              ...
              <span className="pg-grail__pos tt-numeral">{player.orderIndex + 1}</span>
              ...
              <span className="pg-grail__body">
                ...
                <span className="pg-grail__meta">
                  ...
                  <span className="tt-numeral">{player.cities.length}</span> cities
                </span>
              </span>
      ...
      <div className="pg-grail__foot">
        ...
        <p className="tt-caption">{meta.summary}</p>
      </div>
    </Panel>
  );
}
