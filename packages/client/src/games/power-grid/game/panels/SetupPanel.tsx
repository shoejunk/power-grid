  ...
  return (
    ...
    >
      <div className="pg-gsummary">
        <Stat label="Areas" value={<span className="tt-numeral">{`${picked.length}/${required}`}</span>} />
        <Stat label="Cities in play" value={<span className="tt-numeral">{cityCount}</span>} />
        <Stat label="Players" value={<span className="tt-numeral">{state.settings.playerCount}</span>} />
      </div>
        ...
        {map.areas.map((area) => {
          ...
          return (
            ...
            >
              ...
              <span className="pg-garea__count tt-caption">
