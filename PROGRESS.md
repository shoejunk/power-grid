...
- [ ] Stage 1 — rules and board: clearer starting cities; zones 2/3/4/5/6 players = 3/3/4/5/5; investigate and fix hybrid resource storage; successful resource purchase ends the player's resource turn (retain skipping without a purchase).
- [ ] Stage 2 — lobby and navigation: immediate readiness, remove ready toggle; remove turn notifications; invite code takes precedence over existing session; creator-defined game names, including mid-game rename and invite-code fallback in game lists.
